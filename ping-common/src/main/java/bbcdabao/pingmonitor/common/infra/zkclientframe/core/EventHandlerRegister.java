...
package bbcdabao.pingmonitor.common.infra.zkclientframe.core;
...
import bbcdabao.pingmonitor.common.infra.zkclientframe.BaseEventHandler.IRegister;
import bbcdabao.pingmonitor.common.infra.zkclientframe.ZkclientframeConfig;
import bbcdabao.pingmonitor.common.infra.zkclientframe.core.PathManager.BaseEventSender;
...
import bbcdabao.pingmonitor.common.infra.zkclientframe.event.IEvent;
...
public class EventHandlerRegister implements IRegister {
    ...
    private static IRegister getIRegister() {
        ZkclientframeConfig config =
                SpringFactory.getInstance().getBean(ZkclientframeConfig.class);
