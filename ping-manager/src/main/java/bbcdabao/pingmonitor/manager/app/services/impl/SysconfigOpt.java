...
public class SysconfigOpt implements ISysconfig {
    ...
    public Sysconfig getConfig() throws Exception {
        return CoordinationManager.getInstance().getSysconfig();
    }
    @Override
    public void setConfig(Sysconfig sysconfig) throws Exception {
        CoordinationManager.getInstance().setSysconfig(sysconfig);
    }
}